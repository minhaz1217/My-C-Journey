    ...
    if(choice==1)
    {
        ...
        if(choice==1)
        {
            ...
            if(choice==1)
            {
                ...
                int Quantity;
                cin>>Quantity;
                totalBillAmount += panjabi.get_total_bill(Quantity);
                panjabi.view_total_amount();
...
p:
            ...
            else if(choice==2)
            {
                ...
                int Quantity;
                cin>>Quantity;
                totalBillAmount += shirt.get_total_bill(Quantity);
                shirt.view_total_amount();
q:
                cout<<"Do You Want to Buy More?"<<endl<< "1 : Yes" <<endl<< "2 : No" <<endl;
                cin>>choice;
                if(choice==1)
            ...
            else if(choice==3)
            {
                ...
                int Quantity;
                cin>>Quantity;
                totalBillAmount += pant.get_total_bill(Quantity);
                pant.view_total_amount();
r :
                cout<<"Do You Want to Buy More?"<<endl<< "1 : Yes" <<endl<< "2 : No" <<endl;
                cin>>choice;
                if(choice==1)
        ...
        else if(choice==2)
        {
            ...
            if(choice==1)
            {
                ...
                int Quantity;
                cin>>Quantity;
                totalBillAmount += shari.get_total_bill(Quantity);
                shari.view_total_amount();
s:
                cout<<"Do You Want to Buy More?"<<endl<< "1 : Yes" <<endl<< "2 : No" <<endl;
                cin>>choice;
                if(choice==1)
            ...
            else if(choice==2)
            {
                ...
                int Quantity;
                cin>>Quantity;
                totalBillAmount += borka.get_total_bill(Quantity);
                borka.view_total_amount();
t:
                cout<<"Do You Want to Buy More?"<<endl<< "1 : Yes" <<endl<< "2 : No" <<endl;
                cin>>choice;
                if(choice==1)
            ...
            else if(choice==3)
            {
                ...
                int Quantity;
                cin>>Quantity;
                totalBillAmount += kamij.get_total_bill(Quantity);
                kamij.view_total_amount();
u :
                cout<<"Do You Want to Buy More?"<<endl<< "1 : Yes" <<endl<< "2 : No" <<endl;
                cin>>choice;
                if(choice==1)
    ...
    else if(choice==2)
    {
        ...
        if(choice==1)
        {
            ...
            if(choice==1)
            {
                ...
                int Quantity;
                cin>>Quantity;
                totalBillAmount += bat.get_total_bill(Quantity);
                bat.view_total_amount();
a :
                cout<<"Do You Want to Buy More?"<<endl<< "1 : Yes" <<endl<< "2 : No" <<endl;
                cin>>choice;
                if(choice==1)
            ...
            else if(choice==2)
            {
                ...
                int Quantity;
                cin>>Quantity;
                totalBillAmount += ball.get_total_bill(Quantity);
                ball.view_total_amount();
b:
                cout<<"Do You Want to Buy More?"<<endl<< "1 : Yes" <<endl<< "2 : No" <<endl;
                cin>>choice;
                if(choice==1)
            ...
            else if(choice==3)
            {
                ...
                int Quantity;
                cin>>Quantity;
                totalBillAmount += stamp.get_total_bill(Quantity);
                stamp.view_total_amount();
c:
                cout<<"Do You Want to Buy More?"<<endl<< "1 : Yes" <<endl<< "2 : No" <<endl;
                cin>>choice;
                if(choice==1)
        ...
        else if(choice==2)
        {
            ...
            if(choice==1)
            {
                ...
                int Quantity;
                cin>>Quantity;
                totalBillAmount += football.get_total_bill(Quantity);
                football.view_total_amount();
d:
                cout<<"Do You Want to Buy More?"<<endl<< "1 : Yes" <<endl<< "2 : No" <<endl;
                cin>>choice;
                if(choice==1)
            ...
            else if(choice==2)
            {
                ...
                int Quantity;
                cin>>Quantity;
                totalBillAmount += jerssy.get_total_bill(Quantity);
                jerssy.view_total_amount();
e:
                cout<<"Do You Want to Buy More?"<<endl<< "1 : Yes" <<endl<< "2 : No" <<endl;
                cin>>choice;
                if(choice==1)
            ...
            else if(choice==3)
            {
                ...
                int Quantity;
                cin>>Quantity;
                totalBillAmount += boot.get_total_bill(Quantity);
                boot.view_total_amount();
f:
                cout<<"Do You Want to Buy More?"<<endl<< "1 : Yes" <<endl<< "2 : No" <<endl;
                cin>>choice;
                if(choice==1)
    ...
    else if(choice==3)
    {
        ...
        if(choice==1)
        {
            ...
            if(choice==1)
            {
                ...
                int Quantity;
                cin>>Quantity;
                totalBillAmount += htc.get_total_bill(Quantity);
                htc.view_total_amount();
g:
                cout<<"Do You Want to Buy More?"<<endl<< "1 : Yes" <<endl<< "2 : No" <<endl;
                cin>>choice;
                if(choice==1)
            ...
            else if(choice==2)
            {
                ...
                int Quantity;
                cin>>Quantity;
                totalBillAmount += iphone.get_total_bill(Quantity);
                iphone.view_total_amount();
h:
                cout<<"Do You Want to Buy More?"<<endl<< "1 : Yes" <<endl<< "2 : No" <<endl;
                cin>>choice;
                if(choice==1)
            ...
            else if(choice==3)
            {
                ...
                int Quantity;
                cin>>Quantity;
                totalBillAmount += walton.get_total_bill(Quantity);
                walton.view_total_amount();
i:
                cout<<"Do You Want to Buy More?"<<endl<< "1 : Yes" <<endl<< "2 : No" <<endl;
                cin>>choice;
                if(choice==1)
        ...
        else if(choice==2)
        {
            ...
            if(choice==1)
            {
                ...
                int Quantity;
                cin>>Quantity;
                totalBillAmount += tv.get_total_bill(Quantity);
                tv.view_total_amount();
j:
                cout<<"Do You Want to Buy More?"<<endl<< "1 : Yes" <<endl<< "2 : No" <<endl;
                cin>>choice;
                if(choice==1)
            ...
            else if(choice==2)
            {
                ...
                int Quantity;
                cin>>Quantity;
                totalBillAmount += ac.get_total_bill(Quantity);
                ac.view_total_amount();
k:
                cout<<"Do You Want to Buy More?"<<endl<< "1 : Yes" <<endl<< "2 : No" <<endl;
                cin>>choice;
                if(choice==1)
            ...
            else if(choice==3)
            {
                ...
                int Quantity;
                cin>>Quantity;
                totalBillAmount += oven.get_total_bill(Quantity);
                oven.view_total_amount();
l:
                cout<<"Do You Want to Buy More?"<<endl<< "1 : Yes" <<endl<< "2 : No" <<endl;
                cin>>choice;
                if(choice==1)
...
cashout:
    cout << "Your total bill is: " << totalBillAmount << endl;
    return 0;
}
