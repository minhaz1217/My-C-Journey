...
int main(){
    ...
    cout << "The French Franc value for this is: " << (amount/1.487)*0.172 << endl;
    cout << "The German Deutschemark value for this is: " << (amount/1.487) * 0.584 << endl;
    cout << "The Japanese Yes value for this is: " << (amount/1.487) * 0.00955 << endl;
    */
