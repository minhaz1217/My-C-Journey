...
public:
    ...
    int senior_employee(int);
    int junior_employe(int);
    int Servent(int);
...
class Servent_salary:public input,public value
{
...
int main()
{
    ...
    */
    ...
    F.total_salary();
    */
    value *s_obj,*j_obj,*sv_obj;
    s_obj = new Senior_employee_salary();
    j_obj = new junior_employee_salary();
    sv_obj = new Servent_salary();
