...
void displayInit(){
    system("cls");
    SetConsoleTitle("CSE205 Project - A Traveling Salesperson");
    changeConsoleColor(27);
    cout <<setw(64) << "" << endl;
    cout << "\t\t\tA Traveling Salesperson\t\t\t" << endl;
    cout <<setw(64) << "" << endl;
    cout << endl;
...
void init2(){
    int l[nodes][nodes]={0,7,0,13,0,10,0,0,0,0,
7,0,6,15,0,0,0,0,0,0,
0,6,0,10,14,0,0,14,0,0,
13,15,10,0,8,10,11,0,11,0,
0,0,14,8,0,0,7,13,7,7,
10,0,0,10,0,0,0,0,11,0,
0,0,0,11,7,0,0,0,8,13,
0,0,14,0,13,0,0,0,0,12,
0,0,0,11,7,11,8,0,0,0,
0,0,0,0,7,0,13,12,0,0
};
