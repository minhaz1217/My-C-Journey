...
EWU, Bangladesh
Problem Name:
Problem Link: https://vjudge.net/problem/UVA-10065
Date : 01 / September / 2019
Comment: very easy problem. just be sure the make the front and back same point.
*/
#include<bits/stdc++.h>
//#include<iostream>
using namespace std;
