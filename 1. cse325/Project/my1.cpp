...
void showJobQueue(){
    ...
    */
    for(int i=0;i<jobQueue.size();i++){
        cout << setw(10) << jobQueue[i].getProcessID() << setw(10) << jobQueue[i].getProcessName()
        << setw(10) << jobQueue[i].getBurst() << setw(10) << jobQueue[i].getArrivalTime()
        << setw(10) << jobQueue[i].getPriority() << endl;
    }
