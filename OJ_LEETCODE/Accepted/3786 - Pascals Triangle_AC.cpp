...
EWU, Bangladesh
Problem Name:
Problem Link: https://leetcode.com/explore/challenge/card/june-leetcoding-challenge-2021/605/week-3-june-15th-june-21st/3786/
Date : 28 / June / 2021
Comment:
*/
#include<bits/stdc++.h>
...
public:
    ...
    vector<vector<int> > generate(int numRows) {
        BinomialCoefficient(numRows,numRows);
        ...
        for(int i=0;i<numRows;i++){
            ...
            for(int j=0;j<=i;j++){
                if(i==0 && j==0){
                    ...
                    vec.push_back(BinomialCoefficient(i,j));
                }
            }
